                ...
                <div class="card m-1 m-lg-5" style="border-radius: 20px">
                    <div class="card-body p-0">
                        <div class="row m-0">
                            ...
                            <div class="col-12">
                                <form id="form-create-profile" action="{{route('account_index')}}" method="POST">
                                    @csrf
                                    <div class="row  justify-content-center">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                                            <div class="form-group">
                                                <input type="text" name="father_last_name" id="father_last_name" class="form-control mb-4" placeholder="Apellido Paterno">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-2 justify-content-center">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                                            <div class="form-group">
                                                <input type="text" name="mother_last_name" id="mother_last_name" class="form-control mb-4" placeholder="Apellido Materno">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                                            <div class="form-group">
                                                <input type="number" name="phone" id="phone" class="form-control mb-4" placeholder="Telefono">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-2 justify-content-center">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                                            <div class="form-group">
                                                <input type="date" name="birthday" id="birthday" class="form-control mb-4" placeholder="Cumpleaños">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-5">
                                            <div class="form-group">
