...
<head>
    ...
    <title>Rigunes Confirmación de compra</title>
    <style>
...
<body class="">
<span class="preheader">Rigunes | Confirmación de compra</span>
                                        ...
                                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            @foreach($order->saleVariants as $variant)
                                                <tr>
                                                    ...
                                                    <td style="text-align: center">
                                                        <span>{{$variant->pivot->quantity}}</span>
                                                    </td>
                                                    <td style="text-align: center">
                                                        <span>{{'$'.number_format($variant->pivot->sale_price * $variant->pivot->quantity,2)}}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
